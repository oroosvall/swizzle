...
namespace swizzle::gfx
{
    ...
    void VulkanCommandBuffer::begin()
    {
        ...
        getCmdBuffer(mActiveIndex).opCtx = Optick::SetGpuContext(Optick::GPUContext(getCmdBuffer(mActiveIndex).mCmdBuffer));
        OPTICK_GPU_EVENT("VulkanCommandBuffer::begin");
    }

    void VulkanCommandBuffer::end()
    {
        {
            OPTICK_GPU_EVENT("VulkanCommandBuffer::end");
        }
        Optick::SetGpuContext(getCmdBuffer(mActiveIndex).opCtx);
    ...
    {
        OPTICK_GPU_EVENT("VulkanCommandBuffer::draw");
    ...
    {
        OPTICK_GPU_EVENT("VulkanCommandBuffer::drawIndexed");
        auto& cmdBuf = getCmdBuffer(mActiveIndex);
