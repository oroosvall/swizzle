...
namespace swizzle::gui
{
    ...
    void Label::setText(const SwChar* text)
    {
        ...
        {
            SwChar c = text[i];
            const FontGlyph& glyph = mFont.getGlyph((U32)c);
            ...
            //q.v1 = { xPos    , yPos - h, -1.0F, glyph.mUStart, glyph.mVStart };
            //q.v2 = { xPos    , yPos    , -1.0F, glyph.mUStart, glyph.mVEnd };
            //q.v3 = { xPos + w, yPos    , -1.0F, glyph.mUEnd  , glyph.mVEnd };
            //
            //q.v4 = { xPos    , yPos - h, -1.0F, glyph.mUStart, glyph.mVStart };
            //q.v5 = { xPos + w, yPos    , -1.0F, glyph.mUEnd  , glyph.mVEnd };
            //q.v6 = { xPos + w, yPos - h, -1.0F, glyph.mUEnd  , glyph.mVStart };
    ...
    core::Resource<gfx::Buffer> Label::getBuffer() const
    {
        return mQuadBuffer;
    }

    core::Resource<gfx::Texture> Label::getTexture() const
    {
