                            ...
                            common::Resource<swizzle::core::SwWindow> window)
{
    ...
    bd->mVertexBuffer =
        dev->createBuffer(swizzle::gfx::GfxBufferType::Vertex, swizzle::gfx::GfxMemoryArea::DeviceLocalHostVisible);
    bd->mIndexBuffer =
        dev->createBuffer(swizzle::gfx::GfxBufferType::Index, swizzle::gfx::GfxMemoryArea::DeviceLocalHostVisible);
...
void ImGui_ImplSwizzle_NewFrame(common::Resource<swizzle::core::SwWindow> window, DeltaTime dt)
{
    ImGuiIO& io = ImGui::GetIO();
    io.DeltaTime = dt;
